    ...
    itemtype="https://schema.org/WebContent" class="lg:pt-28 pt-14">
        <div class="container max-w-7xl m-auto px-4">
            <header class="max-w-[750px] mx-auto mb-16">
                <h2 itemprop="headline" class="title-primary mb-4 "><span itemprop="name" class="text-green">Frequently</span> Asked Questions</h2>
            </header>
...
export default {
    data() {
        return {
            faqItems: [
                {
                    question: "How much control do I have over my dedicated team?",
                    answer: "At ReformedTech.ca, we believe in transparent collaboration. You'll have complete visibility and control over your dedicated team, enabling you to manage their tasks, monitor progress, and provide direction. We use project management tools that allow you to track tasks, communicate with the team, and review deliverables in real time, ensuring you are always in the loop.",
                    open: true
                },
                {
                    question: "Is using in-house developers better than hiring an external team?",
                    answer: "Both offer unique advantages. While in-house developers may have a deeper understanding of your organization, external teams like ours bring fresh perspectives, specialized expertise, and the ability to scale resources on demand.",
                    open: false
                },
